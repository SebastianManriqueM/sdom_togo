...
- 2026-07-03: After upgrading the local `.venv` package to SDOM 0.2.5, module 5 (`training/5_sdom_parametric_advanced/run_m5.py`) completed 18/18 optimal cases in 2415.68 seconds and regenerated advanced sensitivity plots under `training/5_sdom_parametric_advanced/sample_output/sensitivity_plots/`.
- 2026-07-03: After upgrading the local `.venv` package to SDOM 0.2.5, module 4 (`training/4_sdom_parametric_scalar/run_m4.py`) completed 2/2 optimal cases in 611.87 seconds and regenerated sensitivity plots under `training/4_sdom_parametric_scalar/sample_output/sensitivity_plots/`.
